...
Most of the UI is prototyped on the last sprints, only two pages need to be finished with prototyping before implementation. 
...
We had some communication issues that also contributed to the delaying of some tickets, especially those in the in progress section. 
From timing it was possible to get all tickets done. 
...
Mostly only communication only in the two meetings per week and the communication there is also not really communication. 
