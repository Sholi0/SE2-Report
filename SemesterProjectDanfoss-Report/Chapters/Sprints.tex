...
The scope was intentionally bigger, by implementing the pages from a Figma prototype with backend support.
\subsection*{Deliverables}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint2Planning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint2Review.png}
