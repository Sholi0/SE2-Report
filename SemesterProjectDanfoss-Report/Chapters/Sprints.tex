...
\subsection*{Deliverables}
The increment during this sprint is implementation of frontend of the overview page, optimizer page, production unit page and configuration page, Also implementation of a data manager in the backend. 
All that in the first half of the sprint. The second half is for connecting the frontend with the backend, so mostly data binding.
\subsection*{Sprint Planning}
...
\subsection*{Sprint Retrospective}
The members seem to be shy about their work and problems. 
For the most part, communication only happens in the two meetings per week and the communication there is also not really great.
Mostly worked on a list of steps like some random exercise and giving half answers with nothing really to say. 
Those are the main problems with working on the dependent tickets in the group.

\subsection*{Reflections and Conflicts}
To resolve the communication issues we talked with each other and implemented an Excalidraw board for writing down issues, an option on Discord for main communiacation. 
