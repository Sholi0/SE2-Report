...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint1Planning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint1Review.png}
...
We had issues with Jira's features and assignment of tasks. The team assigned did not show up on the board, subtasks are not easy to distribute and splitting tasks requires a lot of effort due to interdependecies, and there is no ability to assign someone to review the tasks.\par
...
\section{Sprint 2}
\subsection*{Summary}
This sprint is for learning how big the workload could be for a sprint.
Learning where our current communication could be improved, in the group.
The scope is intentionally bigger, by implementing the pages from a Figma prototype with backend support.
\subsection*{Deliverables}
The Sprint goal is to get the program finished, visual and functional for Scenario 1. The increment during this sprint is implementation of frontend of the overview page, optimizer page, production unit page and configuration page. Furthermore, implementation of Data Manager in the backend was completed. 
...
\subsection*{Sprint Planning}
This sprint is an experiment for how much work could be done in a sprint. 
...
For implement the connection, Data Manager class was additionally designed and it required implementation this sprint. 
...
There are quite a lot of dependent tasks (see Figure 3.3), and they will test how great our group communication is.
...
\subsection*{Sprint Review}
At the end of this sprint, most of the UI implementation is done or in review. 
...
\subsection*{Sprint Retrospective}
Because of underestimations and a misunderstanding by the Scrum Master, there are no written logs from the Sprint Retrospective.
...
The members seem to be shy about their work and problems, not saying anything more in the meetings.
...
\subsection*{Reflections and Conflicts}
To resolve the communication issues we talked with each other, and improved our Excalidraw board for writing down issues, hopefully easier for shy team members. Taking development issues more seriously, optionally asking for help on Discord. 
...
A member has now the options, if they have issues with their task taking too long - to publish early the branch what he/she is working on, writing down the issue on Discord or Excalidraw board, talking to a team member, or also talking to the current Scrum Master. 
...
\subsection*{Sprint Planning}
The sprint goal is to implement the connection between backend and frontend parts, implementing export from RDM. The main goal is to reach Scenario 1. The Sprint consisted of uncompleted tasks form the last Sprint.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint3Planning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint3Review.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint4Planning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint4Review.png}
...
\subsection*{Reflections and Conflicts}
To resolve the issues, we first identified the reason behind team members getting late or being absent, which turned out to be an issue with oversleeping. We came up with a solution to move the time of the meeting to a later hour to see if that will improve the attendance. Moreover, during the discussion another issue was found. Some members felt that the ending of the meetings is not clear enough, and to solve it we decided to have a question if everyone is ready to end the meeting.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint5Planning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{Figures/Sprint/Sprint5Review.png}
