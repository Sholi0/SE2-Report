...
\end{figure}
\subsection*{Sprint Review}
At the end of the sprint, most of the tasks were completed or in review (see Image y), with two tasks in progress and only one not started. The increment of the product did not fully satisfy the sprint goal, however we progressed a lot towards finishing the application. The Sprint 4 demonstration was moved to a later date, therefore we did not receive feedback from the stakeholders at the end of the sprint.
\begin{figure}[H]
    \centering
